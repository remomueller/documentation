...
=== 31 Curl needs a new cacert.pem file to work correctly (CentOS 5.7 only)
...
Or in /usr/local/nginx/conf/nginx.conf
...
Or Restart Nginx, http://wiki.nginx.org/CommandLine#Stopping_or_Restarting_Nginx
