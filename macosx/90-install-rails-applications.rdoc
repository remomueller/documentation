...
=== 51 Initialize Production Directory and Permissions
...
=== 52 Installing MySQL Library to allow compilation of mysql2 ruby gem
...
Select <tt>Mac OS X ver. 10.6 (x86, 64-bit), DMG Archive</tt>

  mysql-5.1.61-osx10.6-x86_64.dmg

=== 53 Install individual Ruby on Rails Applications

* {Hybrid}[https://github.com/remomueller/hybrid]
  * Sleep Portal code base
* {Notes}[https://github.com/remomueller/notes]
  * Task Tracker code base
...
{99 - Miscellaneous}[https://github.com/remomueller/documentation/tree/master/macosx/99-miscellaneous.rdoc]
